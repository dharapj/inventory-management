...
import * as inventoryActions from './inventoryActions'; // Import all actions
import * as inventorySelectors from './inventorySelectors'; // Import all selectors

// Re-export actions for direct named imports
export const { setInventory, toggleAdminView, editProduct, deleteProduct, disableProduct } = inventoryActions;

// Re-export selectors for direct named imports
export const { selectSummary, selectInventory } = inventorySelectors;

// Export grouped objects for convenience
export { inventoryActions, inventorySelectors };
